...
infile = 'serprot_pairs.out'
# set the input file as serprot_pairs.out
fh = open(infile)
...
colnames=['I', 'J', 'ILEN', 'JLEN', 'MATCH', 'NGAPS', 'NALIG', 'NIDENT', '%IDENT', 'NAS', 'NASAL', 'NRANS', 'RMEAN', 'STEDEV', 'SCORE']
# set the columnnames
outfile='serprot_pairs_parsed.txt'
